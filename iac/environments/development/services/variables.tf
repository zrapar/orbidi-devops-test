...
################################################################################
# Remote Key State Variables
################################################################################

variable "tf_backend_core_key" {
  description = "Backend Key to save the terraform state of core module"
  type        = string
  default     = "environments/development/core/terraform.tfstate"
}

variable "tf_backend_data_key" {
  description = "Backend Key to save the terraform state of data module"
  type        = string
  default     = "environments/development/data/terraform.tfstate"
}

################################################################################
# AWS S3 Remote State Variables
################################################################################

variable "aws_s3_backend_bucket" {
  type        = string
  nullable    = true
  description = "aws_s3_backend_bucket"
  default     = null
}

variable "aws_s3_backend_region" {
  type        = string
  nullable    = true
  description = "aws_s3_backend_region"
  default     = null
}

variable "aws_s3_backend_access_key" {
  type        = string
  nullable    = true
  description = "aws_s3_backend_access_key"
  default     = null
}

variable "aws_s3_backend_secret_key" {
  type        = string
  nullable    = true
  description = "aws_s3_backend_secret_key"
  default     = null
}
